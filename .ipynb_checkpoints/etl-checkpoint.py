...
def process_log_file(cur, filepath):
    """
    This procedure processes the log file in JSON format whose filepath has been provided as an arugment.
...
def process_data(cur, conn, filepath, func):
    ...
    Args:
        ...
        func (callable): the function to call to process the files.
    """
